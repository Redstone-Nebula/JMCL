...
import org.Open_code_Studio.jmcl.mod.ModManager;
...
import org.Open_code_Studio.jmcl.ui.construct.JFXCheckBoxTableCell;
...
import org.Open_code_Studio.jmcl.util.io.CSVTable;
...
public class ModUpdatesPage extends BorderPane implements DecoratorPage {
    ...
    public ModUpdatesPage(ModManager modManager, List<LocalModFile.ModUpdate> updates) {
        ...
        Button exportListButton = FXUtils.newRaisedButton(i18n("button.export"));
        exportListButton.setOnAction(e -> exportList());

        Button nextButton = FXUtils.newRaisedButton(i18n("mods.check_updates.confirm"));
