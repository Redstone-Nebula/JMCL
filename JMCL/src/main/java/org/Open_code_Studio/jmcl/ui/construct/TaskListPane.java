...
import org.Open_code_Studio.jmcl.download.forge.ForgeNewInstallTask;
import org.Open_code_Studio.jmcl.download.forge.ForgeOldInstallTask;
import org.Open_code_Studio.jmcl.download.game.GameAssetDownloadTask;
import org.Open_code_Studio.jmcl.download.game.GameInstallTask;
import org.Open_code_Studio.jmcl.download.java.mojang.MojangJavaDownloadTask;
import org.Open_code_Studio.jmcl.download.legacyfabric.LegacyFabricInstallTask;
import org.Open_code_Studio.jmcl.download.liteloader.LiteLoaderInstallTask;
import org.Open_code_Studio.jmcl.download.neoforge.NeoForgeInstallTask;
import org.Open_code_Studio.jmcl.download.neoforge.NeoForgeOldInstallTask;
import org.Open_code_Studio.jmcl.download.optifine.OptiFineInstallTask;
import org.Open_code_Studio.jmcl.download.quilt.QuiltAPIInstallTask;
import org.Open_code_Studio.jmcl.download.quilt.QuiltInstallTask;
import org.Open_code_Studio.jmcl.game.JMCLModpackInstallTask;
import org.Open_code_Studio.jmcl.java.JavaInstallTask;
...
import org.Open_code_Studio.jmcl.mod.curse.CurseCompletionTask;
import org.Open_code_Studio.jmcl.mod.curse.CurseInstallTask;
import org.Open_code_Studio.jmcl.mod.mcbbs.McbbsModpackCompletionTask;
import org.Open_code_Studio.jmcl.mod.mcbbs.McbbsModpackExportTask;
import org.Open_code_Studio.jmcl.mod.modrinth.ModrinthCompletionTask;
import org.Open_code_Studio.jmcl.mod.modrinth.ModrinthInstallTask;
...
import org.Open_code_Studio.jmcl.mod.multimc.MultiMCModpackInstallTask;
import org.Open_code_Studio.jmcl.mod.server.ServerModpackCompletionTask;
import org.Open_code_Studio.jmcl.mod.server.ServerModpackExportTask;
import org.Open_code_Studio.jmcl.mod.server.ServerModpackLocalInstallTask;
...
import static org.Open_code_Studio.jmcl.util.Lang.tryCast;
...
public final class TaskListPane extends StackPane {
    ...
    private final class Cell extends ListCell<Node> {
        ...
        private Cell() {
            bar.getStyleClass().add("md3-linear-progress");
