...
import org.Open_code_Studio.jmcl.ui.construct.LineFileChooserButton;
...
public class WorldExportPageSkin extends SkinBase<WorldExportPage> {
    ...
    public WorldExportPageSkin(WorldExportPage skinnable) {
        ...
        TextField txtWorldName = new TextField();
        ...
        Button btnExport = FXUtils.newRaisedButton(i18n("button.export"));
