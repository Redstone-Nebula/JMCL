...
import static org.Open_code_Studio.jmcl.download.LibraryAnalyzer.LibraryType.MINECRAFT;
...
class AdditionalInstallersPage extends AbstractInstallersPage {
    ...
    public AdditionalInstallersPage(String gameVersion, Version version, WizardController controller, JMCLGameRepository repository, DownloadProvider downloadProvider) {
        ...
        installable.bind(Bindings.createBooleanBinding(() -> compatible.get() && txtName.validate().isEmpty(), txtName.textProperty(), compatible));
    }
