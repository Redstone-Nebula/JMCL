...
import org.Open_code_Studio.jmcl.game.GraphicsAPI;
import org.Open_code_Studio.jmcl.game.NativesDirectoryType;
import org.Open_code_Studio.jmcl.game.Renderer;
...
public final class AdvancedVersionSettingPage extends StackPane implements DecoratorPage {
    ...
    private final TextField txtJVMArgs;
    private final TextField txtGameArgs;
    private final TextField txtEnvironmentVariables;
    private final TextField txtMetaspace;
    private final TextField txtWrapper;
    private final TextField txtPreLaunchCommand;
    private final TextField txtPostExitCommand;
    ...
    public AdvancedVersionSettingPage(Profile profile, @Nullable String versionId, VersionSetting versionSetting) {
        ...
        ComponentList customCommandsPane = new ComponentList();
        {
            ...
            txtPreLaunchCommand = new TextField();
            ...
            txtPostExitCommand = new TextField();
        ...
        ComponentList jvmPane = new ComponentList();
        {
            ...
            txtEnvironmentVariables = new TextField();
