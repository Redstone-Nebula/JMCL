...
import org.Open_code_Studio.jmcl.mod.ModLoaderType;
...
import org.Open_code_Studio.jmcl.util.Lazy;
import org.Open_code_Studio.jmcl.util.Pair;
...
import static org.Open_code_Studio.jmcl.ui.ToolbarListPageSkin.createToolbarButton2;
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    Controllers.navigate(new DownloadPage(
                                            ...
                                            (downloadProvider, profile, version, mod, file) -> org.Open_code_Studio.jmcl.ui.download.DownloadPage.download(downloadProvider, profile, version, file, "mods")
                                    ));
                                });
