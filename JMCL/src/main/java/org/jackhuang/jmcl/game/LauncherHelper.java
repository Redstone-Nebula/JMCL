 ...
 */
package org.jackhuang.jmcl.game;

import com.jfoenix.controls.JFXButton;
import javafx.stage.Stage;
import org.jackhuang.jmcl.Launcher;
import org.jackhuang.jmcl.auth.*;
import org.jackhuang.jmcl.auth.authlibinjector.AuthlibInjectorDownloadException;
import org.jackhuang.jmcl.auth.offline.OfflineAccount;
import org.jackhuang.jmcl.download.DefaultDependencyManager;
import org.jackhuang.jmcl.download.DownloadProvider;
import org.jackhuang.jmcl.download.LibraryAnalyzer;
import org.jackhuang.jmcl.download.MaintainTask;
import org.jackhuang.jmcl.download.game.*;
import org.jackhuang.jmcl.java.JavaManager;
import org.jackhuang.jmcl.java.JavaRuntime;
import org.jackhuang.jmcl.launch.*;
import org.jackhuang.jmcl.mod.ModpackCompletionException;
import org.jackhuang.jmcl.mod.ModpackConfiguration;
import org.jackhuang.jmcl.mod.ModpackProvider;
import org.jackhuang.jmcl.setting.*;
import org.jackhuang.jmcl.task.*;
import org.jackhuang.jmcl.ui.*;
import org.jackhuang.jmcl.ui.construct.DialogCloseEvent;
import org.jackhuang.jmcl.ui.construct.MessageDialogPane;
import org.jackhuang.jmcl.ui.construct.MessageDialogPane.MessageType;
import org.jackhuang.jmcl.ui.construct.PromptDialogPane;
import org.jackhuang.jmcl.ui.construct.TaskExecutorDialogPane;
import org.jackhuang.jmcl.util.*;
import org.jackhuang.jmcl.util.i18n.I18n;
import org.jackhuang.jmcl.util.io.FileUtils;
import org.jackhuang.jmcl.util.io.ResponseCodeException;
import org.jackhuang.jmcl.util.platform.*;
import org.jackhuang.jmcl.util.versioning.GameVersionNumber;
import org.jackhuang.jmcl.util.versioning.VersionNumber;
...
import static org.jackhuang.jmcl.setting.ConfigHolder.config;
import static org.jackhuang.jmcl.ui.FXUtils.runInFX;
import static org.jackhuang.jmcl.util.DataSizeUnit.MEGABYTES;
import static org.jackhuang.jmcl.util.Lang.resolveException;
import static org.jackhuang.jmcl.util.i18n.I18n.i18n;
import static org.jackhuang.jmcl.util.logging.Logger.LOG;
import static org.jackhuang.jmcl.util.platform.Platform.SYSTEM_PLATFORM;
...
public final class LauncherHelper {
    ...
    private void launch0() {
        // https://github.com/Open-code-Studio/JMCL/pull/4121
        ...
        TaskExecutor executor = checkGameState(profile, setting, version.get())
                ...
                .withStagesHints(
                        ...
                        new Task.StagesHint("launch.state.dependencies", List.of("jvmmcl.install.assets", "jvmmcl.install.libraries", "jvmmcl.modpack.download")),
    ...
    private final class HMCLProcessListener implements ProcessListener {
        ...
        public HMCLProcessListener(JMCLGameRepository repository, Version version, AuthInfo authInfo, LaunchOptions launchOptions, CountDownLatch launchingLatch, boolean detectWindow) {
