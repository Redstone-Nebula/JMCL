...
import org.jackhuang.jmcl.event.Event;
import org.jackhuang.jmcl.event.EventManager;
import org.jackhuang.jmcl.java.JavaRuntime;
import org.jackhuang.jmcl.mod.ModAdviser;
...
public final class JMCLGameRepository extends DefaultGameRepository {
    ...
    public JMCLGameRepository(Profile profile, Path baseDirectory) {
        super(baseDirectory);
    ...
    private Path getLocalVersionSettingFile(String id) {
        return getVersionRoot(id).resolve("jmclversion.cfg");
    }
