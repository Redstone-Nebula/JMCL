...
public final class ConfigHolder {
    ...
    public static final String CONFIG_FILENAME = "jvmmcl.json";
    public static final String CONFIG_FILENAME_LINUX = ".hmcl.json";
    public static final Path GLOBAL_CONFIG_PATH = Metadata.GLOBAL_DIRECTORY.resolve("config.json");
    ...
    private static Path locateConfig() {
        Path defaultConfigFile = Metadata.LOCAL_DIRECTORY.resolve(CONFIG_FILENAME);
