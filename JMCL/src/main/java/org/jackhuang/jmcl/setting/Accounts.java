 ...
 */
package org.jackhuang.jmcl.setting;
...
import org.jackhuang.jmcl.auth.authlibinjector.*;
import org.jackhuang.jmcl.auth.microsoft.MicrosoftAccount;
import org.jackhuang.jmcl.auth.microsoft.MicrosoftAccountFactory;
import org.jackhuang.jmcl.auth.microsoft.MicrosoftService;
import org.jackhuang.jmcl.auth.offline.OfflineAccount;
import org.jackhuang.jmcl.auth.offline.OfflineAccountFactory;
import org.jackhuang.jmcl.auth.yggdrasil.RemoteAuthenticationException;
import org.jackhuang.jmcl.game.OAuthServer;
import org.jackhuang.jmcl.task.Schedulers;
import org.jackhuang.jmcl.util.FileSaver;
import org.jackhuang.jmcl.util.io.JarUtils;
import org.jackhuang.jmcl.util.skin.InvalidSkinException;
...
import static org.jackhuang.jmcl.ui.FXUtils.onInvalidating;
import static org.jackhuang.jmcl.util.Lang.immutableListOf;
import static org.jackhuang.jmcl.util.Lang.mapOf;
import static org.jackhuang.jmcl.util.Pair.pair;
import static org.jackhuang.jmcl.util.gson.JsonUtils.listTypeOf;
import static org.jackhuang.jmcl.util.gson.JsonUtils.mapTypeOf;
...
public final class Accounts {
    ...
    private static void loadGlobalAccountStorages() {
        Path globalAccountsFile = Metadata.GLOBAL_DIRECTORY.resolve("accounts.json");
    ...
    private static AuthlibInjectorArtifactProvider createAuthlibInjectorArtifactProvider() {
        String authlibinjectorLocation = System.getProperty("jvmmcl.authlibinjector.location");
        ...
        String authlibInjectorVersion = JarUtils.getAttribute("jvmmcl.authlib-injector.version", null);
