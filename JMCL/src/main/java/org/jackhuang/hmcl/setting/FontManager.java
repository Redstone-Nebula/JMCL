...
public final class FontManager {
    ...
    private static final Lazy<Font> DEFAULT_FONT = new Lazy<>(() -> {
        ...
        font = tryLoadLocalizedFont(Metadata.LOCAL_DIRECTORY.resolve("font"));
        if (font != null)
            return font;

        font = tryLoadLocalizedFont(Metadata.GLOBAL_DIRECTORY.resolve("font"));
        if (font != null)
            return font;

        // Legacy

        font = tryLoadDefaultFont(Metadata.LOCAL_DIRECTORY);
        if (font != null)
            return font;
        ...
        font = tryLoadDefaultFont(Metadata.GLOBAL_DIRECTORY);
        if (font != null)
            return font;
    ...
    private static void updateFont() {
        ...
        if (fontFamily == null)
            fontFamily = System.getProperty("jvmmcl.font.override");
        if (fontFamily == null)
            fontFamily = System.getenv("JVM-MCL_FONT");
    ...
    // https://github.com/Open-code-Studio/JMCL/issues/4072
