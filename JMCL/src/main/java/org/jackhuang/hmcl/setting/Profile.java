...
import org.jackhuang.jmcl.event.EventPriority;
import org.jackhuang.jmcl.event.RefreshedVersionsEvent;
import org.jackhuang.jmcl.game.JMCLCacheRepository;
...
import org.jackhuang.jmcl.util.javafx.ObservableHelper;
...
public final class Profile implements Observable {
    ...
    public Profile(String name, Path initialGameDir, VersionSetting global, String selectedVersion, boolean useRelativePath) {
        ...
        repository = new JMCLGameRepository(this, initialGameDir);
    ...
    public JMCLGameRepository getRepository() {
        return repository;
    }
    ...
    public DefaultDependencyManager getDependency(DownloadProvider downloadProvider) {
        return new DefaultDependencyManager(repository, downloadProvider, JMCLCacheRepository.REPOSITORY);
    }
