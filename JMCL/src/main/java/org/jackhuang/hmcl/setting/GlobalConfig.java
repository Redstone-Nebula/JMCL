...
import org.jackhuang.jmcl.util.gson.ObservableSetting;
...
public final class GlobalConfig extends ObservableSetting {
    ...
    @SerializedName("showInstallationLog")
    private final BooleanProperty showInstallationLog = new SimpleBooleanProperty(false);

    public BooleanProperty showInstallationLogProperty() {
        return showInstallationLog;
    }

    public boolean isShowInstallationLog() {
        return showInstallationLog.get();
    }

    public void setShowInstallationLog(boolean value) {
        showInstallationLog.set(value);
    }
