...
import org.jackhuang.jmcl.download.java.mojang.MojangJavaRemoteFiles;
 ...
 * @author Glavo
 */
public final class JMCLJavaRepository implements JavaRepository {
    public static final String MOJANG_JAVA_PREFIX = "mojang-";

    private final Path root;

    public JMCLJavaRepository(Path root) {
        this.root = root;
    }
