...
import org.jackhuang.jmcl.mod.LocalModFile;
import org.jackhuang.jmcl.mod.ModLoaderType;
...
import org.jackhuang.jmcl.util.Lazy;
import org.jackhuang.jmcl.util.Pair;
...
import org.jackhuang.jmcl.util.io.NetworkUtils;
...
import static org.jackhuang.jmcl.ui.FXUtils.ignoreEvent;
import static org.jackhuang.jmcl.ui.FXUtils.onEscPressed;
import static org.jackhuang.jmcl.ui.ToolbarListPageSkin.createToolbarButton2;
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    Controllers.navigate(new DownloadPage(
                                            ...
                                            (downloadProvider, profile, version, mod, file) -> org.jackhuang.jmcl.ui.download.DownloadPage.download(downloadProvider, profile, version, file, "mods")
                                    ));
                                });
