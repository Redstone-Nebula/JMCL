...
import org.jackhuang.jmcl.mod.ModManager;
...
import org.jackhuang.jmcl.ui.construct.JFXCheckBoxTableCell;
import org.jackhuang.jmcl.ui.construct.MessageDialogPane;
import org.jackhuang.jmcl.ui.construct.PageCloseEvent;
...
import org.jackhuang.jmcl.util.io.CSVTable;
...
public class ModUpdatesPage extends BorderPane implements DecoratorPage {
    ...
    private void exportList() {
        Path path = Paths.get("jmcl-mod-update-list-" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH-mm-ss")) + ".csv").toAbsolutePath();
