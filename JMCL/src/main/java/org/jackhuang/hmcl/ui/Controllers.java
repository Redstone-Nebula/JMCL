...
import org.jackhuang.jmcl.game.LauncherHelper;
...
import org.jackhuang.jmcl.ui.account.AccountListPage;
...
import org.jackhuang.jmcl.ui.decorator.DecoratorController;
import org.jackhuang.jmcl.ui.download.DownloadPage;
import org.jackhuang.jmcl.ui.download.ModpackInstallWizardProvider;
import org.jackhuang.jmcl.ui.main.LauncherSettingsPage;
import org.jackhuang.jmcl.ui.main.RootPage;
import org.jackhuang.jmcl.ui.terracotta.TerracottaPage;
import org.jackhuang.jmcl.ui.versions.GameListPage;
...
import org.jackhuang.jmcl.util.i18n.SupportedLocale;
...
import static org.jackhuang.jmcl.setting.ConfigHolder.globalConfig;
...
public final class Controllers {
    ...
    public static void onHyperlinkAction(String href) {
        if (href.startsWith("jmcl://")) {
            switch (href) {
                case "jmcl://settings/feedback":
                    Controllers.getSettingsPage().showFeedback();
                    Controllers.navigate(Controllers.getSettingsPage());
                    break;
                case "jmcl://game/launch":
