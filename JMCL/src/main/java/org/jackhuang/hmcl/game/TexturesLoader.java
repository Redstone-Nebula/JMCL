...
import org.jackhuang.jmcl.auth.offline.Skin;
import org.jackhuang.jmcl.auth.yggdrasil.*;
...
import org.jackhuang.jmcl.util.Holder;
...
public final class TexturesLoader {
    ...
    private static final Path TEXTURES_DIR = Metadata.GLOBAL_DIRECTORY.resolve("skins");
