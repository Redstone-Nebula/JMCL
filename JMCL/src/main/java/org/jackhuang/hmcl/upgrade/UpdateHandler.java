 ...
 */
package org.jackhuang.jmcl.upgrade;

import com.google.gson.Gson;
import com.google.gson.JsonParseException;
import javafx.application.Platform;
import org.jackhuang.jmcl.EntryPoint;
import org.jackhuang.jmcl.Main;
...
import org.jackhuang.jmcl.ui.UpgradeDialog;
...
import org.jackhuang.jmcl.util.SwingUtils;
...
import static org.jackhuang.jmcl.ui.FXUtils.checkFxUserThread;
import static org.jackhuang.jmcl.util.Lang.thread;
...
public final class UpdateHandler {
    ...
    public static void updateFrom(RemoteVersion version) {
        ...
        Controllers.dialog(new UpgradeDialog(version, () -> {
            ...
            Task<?> task = new JMCLDownloadTask(version, downloaded);
    ...
    public static void startJava(Path jar, String... appArgs) throws IOException {
        ...
        try {
            ...
            for (Map.Entry<Object, Object> entry : System.getProperties().entrySet()) {
                if (entry.getKey() instanceof String key && key.startsWith("jvmmcl.")) {
    ...
    private static boolean isFirstLaunchAfterUpgrade() {
        ...
        if (currentPath != null) {
            Path updated = Metadata.GLOBAL_DIRECTORY.resolve("JVM-MCL-" + Metadata.VERSION + ".jar");
    ...
    private static void breakForceUpdateFeature() {
        Path hmclVersionJson = Metadata.GLOBAL_DIRECTORY.resolve("jvmmclver.json");
