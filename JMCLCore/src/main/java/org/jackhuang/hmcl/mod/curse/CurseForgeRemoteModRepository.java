 ...
 */
package org.jackhuang.jmcl.mod.curse;
...
import org.jackhuang.jmcl.util.MurmurHash2;
...
public final class CurseForgeRemoteModRepository implements RemoteModRepository {
    ...
    private static final String apiKey = System.getProperty("jmcl.curseforge.apikey", JarUtils.getAttribute("jmcl.curseforge.apikey", ""));
    ...
    public SearchResult search(DownloadProvider downloadProvider, String gameVersion, @Nullable RemoteModRepository.Category category, int pageOffset, int pageSize, String searchFilter, SortType sortType, SortOrder sortOrder) throws IOException {
        ...
        try {
            ...
            // https://github.com/Open-code-Studio/JMCL/issues/1549
    ...
    public Optional<RemoteMod.Version> getRemoteVersionByLocalFile(LocalModFile localModFile, Path file) throws IOException {
        ...
        if (hash == 811513880) { // Workaround for https://github.com/Open-code-Studio/JMCL/issues/4597
