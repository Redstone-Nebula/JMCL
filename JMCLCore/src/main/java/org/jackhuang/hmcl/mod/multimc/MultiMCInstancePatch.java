...
import org.jackhuang.jmcl.game.Argument;
import org.jackhuang.jmcl.game.Arguments;
import org.jackhuang.jmcl.game.Artifact;
import org.jackhuang.jmcl.game.AssetIndexInfo;
import org.jackhuang.jmcl.game.CompatibilityRule;
...
import org.jackhuang.jmcl.game.OSRestriction;
import org.jackhuang.jmcl.game.RuledArgument;
import org.jackhuang.jmcl.game.StringArgument;
import org.jackhuang.jmcl.game.Version;
import org.jackhuang.jmcl.util.Immutable;
import org.jackhuang.jmcl.util.Lang;
import org.jackhuang.jmcl.util.StringUtils;
import org.jackhuang.jmcl.util.gson.JsonMap;
import org.jackhuang.jmcl.util.gson.JsonUtils;
import org.jackhuang.jmcl.util.io.NetworkUtils;
import org.jackhuang.jmcl.util.logging.Logger;
...
public final class MultiMCInstancePatch {
    public static final Library BOOTSTRAP_LIBRARY = new Library(new Artifact("org.jackhuang.jmcl", "mmc-bootstrap", "1.0"));
    ...
    public static ResolvedInstance resolveArtifact(List<MultiMCInstancePatch> patches, String versionID) {
...

        {
            ...
            jvmArguments.add(new StringArgument("-Djmcl.mmc.bootstrap=" + NetworkUtils.withQuery("jmcl:///bootstrap_profile_v1/", Map.of(
                    "main_class", mainClass,
                    "installer", MultiMCComponents.getInstallerProfile()
            ))));
            mainClass = "org.jackhuang.jmcl.JMCLMultiMCBootstrap";
        }
