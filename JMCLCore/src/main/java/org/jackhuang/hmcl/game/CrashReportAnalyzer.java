...
public final class CrashReportAnalyzer {
    ...
    public enum Rule {
        ...
        //https://github.com/Open-code-Studio/JMCL/pull/1813
        ...
        // Mod issues
        //https://github.com/Open-code-Studio/JMCL/pull/2038
        ...
        FORGE_REPEAT_INSTALLATION("MultipleArgumentsForOptionException: Found multiple arguments for option (.*?), but you asked for only one"),//https://github.com/Open-code-Studio/JMCL/issues/1880
