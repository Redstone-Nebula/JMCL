...
public final class MultiMCComponents {
    ...
    static {
        ...
        // Check whether MultiMCComponents is 'org.jackhuang.jmcl.mod.multimc.MultiMCComponents'.
        ...
        if (new String(
            ...
            INSTALLER_PROFILE.put("Implementation", "Probably vanilla. Class location is not modified (org.jackhuang.jmcl.mod.multimc.MultiMCComponents).");
        } else {
