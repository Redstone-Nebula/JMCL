...
import org.jackhuang.jmcl.auth.yggdrasil.TextureModel;
import org.jackhuang.jmcl.util.KeyUtils;
...
import org.jackhuang.jmcl.util.io.HttpServer;
...
public class YggdrasilServer extends HttpServer {
    ...
    private Response root(Request request) {
        return ok(mapOf(
                ...
                pair("meta", mapOf(
                        pair("serverName", "JMCL"),
                        pair("implementationName", "JMCL"),
