...
import org.Open_code_Studio.jmcl.game.Argument;
...
import org.Open_code_Studio.jmcl.game.DownloadType;
import org.Open_code_Studio.jmcl.game.GameJavaVersion;
import org.Open_code_Studio.jmcl.game.Library;
import org.Open_code_Studio.jmcl.game.OSRestriction;
import org.Open_code_Studio.jmcl.game.RuledArgument;
import org.Open_code_Studio.jmcl.game.StringArgument;
...
import org.Open_code_Studio.jmcl.util.gson.JsonMap;
...
public final class MultiMCInstancePatch {
    public static final Library BOOTSTRAP_LIBRARY = new Library(new Artifact("org.Open_code_Studio.jmcl", "mmc-bootstrap", "1.0"));
    ...
    public static ResolvedInstance resolveArtifact(List<MultiMCInstancePatch> patches, String versionID) {
...

        {
            ...
            mainClass = "org.Open_code_Studio.jmcl.JMCLMultiMCBootstrap";
        }
