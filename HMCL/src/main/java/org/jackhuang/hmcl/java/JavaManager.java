...
public final class JavaManager {
    ...
    public static final HMCLJavaRepository REPOSITORY = new HMCLJavaRepository(Metadata.GLOBAL_DIRECTORY.resolve("java"));
    public static final HMCLJavaRepository LOCAL_REPOSITORY = new HMCLJavaRepository(Metadata.LOCAL_DIRECTORY.resolve("java"));
