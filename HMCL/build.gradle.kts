...
val hmclPropertiesFile = layout.buildDirectory.file("jvmmcl.properties")
...
tasks.register<JavaExec>("run") {
    ...
    val hmclJavaHome = System.getenv("JVM-MCL_JAVA_HOME")
    ...
    doFirst {
        ...
        logger.quiet("JVM-MCL_JAVA_HOME: {}", hmclJavaHome ?: System.getProperty("java.home"))
    }
}
